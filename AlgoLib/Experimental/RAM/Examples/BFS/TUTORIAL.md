...
Start with [BreadthFirst.lean](Proofs.lean). It contains the only BFS program
...
The proof uses [separate named blocks](../../Verification/NAMED-PROOFS.md) for initialization, scan
...
#eval (BreadthFirst.search .circular Examples.BFS.Inputs.diamond ⟨0, by decide⟩).value
#eval (BreadthFirst.search .twoStacks Examples.BFS.Inputs.diamond ⟨0, by decide⟩).value
```
...
The mathematical vocabulary in [BFSFacts.lean](Facts.lean) is small:
...
[BFSFacts.lean](Facts.lean) reuses the existing graph invariant and scan lemmas
from [Specification/Traversal.lean](../../Library/Graph/Traversal.lean). The
...
[Queue.lean](../../Library/Queue.lean) exposes the same FIFO list model, capacity preconditions,
...
hidden by [DataRefinement.lean](../../Implementations/Natural/DataRefinement.lean); it is neither a BFS invariant
...
| File | Responsibility |
|---|---|
| [BreadthFirst.lean](Proofs.lean) | Student-facing program, invariants, source proof, Loom theorem |
| [BFSFacts.lean](Facts.lean) | Pure graph/bitmap/scan reasoning |
| [Queue.lean](../../Library/Queue.lean), [GraphCursor.lean](../../Library/GraphCursor.lean) | Abstract procedure contracts |
| [QueueRing.lean](../../Implementations/DataStructures/QueueRing.lean) | Circular FIFO RAM implementation |
| [QueueStacks.lean](../../Library/QueueStacks.lean) | Concrete two-stack source program and amortized refinement |
| [StackImplementation.lean](../../Implementations/DataStructures/StackImplementation.lean), [QueueStacksImplementation.lean](../../Implementations/DataStructures/QueueStacksImplementation.lean) | Reusable stack RAM operations and queue linking |
| [GraphCursorImplementation.lean](../../Implementations/DataStructures/GraphCursorImplementation.lean) | Owned read-only adjacency-list cells and actual RAM loads |
| [BFSStorage.lean](Storage.lean) | Disjoint resident storage for graph, bitmap, queue, and source |
| [BFSExecution.lean](Execution.lean) | Local storage, certificate reconstruction, executable and final theorems |
| [DataRefinement.lean](../../Implementations/Natural/DataRefinement.lean) | Generic abstraction map with hidden representation invariant and potential |
...
[composition design and credits](../../Historical/Guides/Composition/README.md).
...
and inferred bound. See [implementation contracts](../../Implementations/IMPLEMENTATION-CONTRACTS.md)
