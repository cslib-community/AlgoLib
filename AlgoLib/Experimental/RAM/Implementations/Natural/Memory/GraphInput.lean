...
/-!
# Construct certified graph inputs

Encodes finite adjacency lists and builds Graph/adjacency representation proofs from labelled edge
triples.

EdgeInput.fromSource supplies the certified input used by public BFS. Host construction of the
encoded input is outside the RAM body cost.
-/
