...
-/
import AlgoLib.Experimental.RAM.Implementations.Natural.Language.Verification
import AlgoLib.Experimental.RAM.Implementations.Natural.Memory.Framing

/-!
# Physical array contracts

Implements typed array references and segment assertions with functional, work, and memory-frame
contracts.

Provides reusable implementation facts to data-structure adapters; algorithm clients use the
logical insertion API.
