...
-/
import AlgoLib.Experimental.RAM.Implementations.Natural.Memory.Sequences
import AlgoLib.Experimental.RAM.Library.Graph.Graph
import Mathlib.Algebra.BigOperators.Ring.Finset

/-!
# Typed graph data-structure contracts

Builds graph-oriented operations from the typed array and sequence interfaces.

The canonical BFS client sees Library/Search; this module serves data-structure implementations
and lower-language regression examples.
