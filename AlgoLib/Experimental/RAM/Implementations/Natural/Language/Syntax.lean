...
-/
import AlgoLib.Experimental.RAM.Implementations.Natural.Memory.Array
...
Provides variable assignment, indexed array operations, arithmetic, scoped locals, branches,
loops, and procedure syntax for implementation programs.

The canonical user programs instead use the certified-operation method syntax.
Legacy/LanguageExamples exercises this lower DSL directly.
