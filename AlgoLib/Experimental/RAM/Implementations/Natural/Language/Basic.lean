...
/-!
# Typed implementation semantics

Defines variables, types, expressions, commands, and costed evaluation independently of the
compiler.

Compiler.lean relates these commands to Machine execution. Public algorithm authors normally work
with Authoring.Program instead.
