...
[EncoderLayout.lean](Natural/EncoderLayout.lean) adds:
...
1. [BreadthFirst.lean](../Examples/BFS/Proofs.lean) remains the same algorithm and proof. It
   invokes the abstract queue operations and supplies the BFS invariants.
2. [BFSQueue.lean](../Examples/BFS/QueueBackend.lean) registers the queue implementations and publishes
...
3. [BFSStorage.lean](../Examples/BFS/Storage.lean) combines queue, bitmap, source, and graph
...
4. [BFSExecution.lean](../Examples/BFS/Execution.lean) combines resident storage with generated
...
in `Examples/BFS/Storage.lean` and `Examples/BFS/Execution.lean`. It is a maintenance guard; the Lean theorems
remain the semantic guarantee.

## Frontend implementation map

The stable [Frontend.lean](../Language/Elaboration.lean) import now re-exports five focused modules:

| Module | Responsibility |
|---|---|
| [Frontend/Syntax.lean](../Language/Elaboration/Syntax.lean) | Statement grammar, loop annotations, contract selection |
| [Frontend/Resources.lean](../Language/Elaboration/Resources.lean) | Resource trees, state views, fragment composition, ownership routing |
| [Frontend/Expressions.lean](../Language/Elaboration/Expressions.lean) | Scalar/array expressions, conditions, source locations, local charges |
| [Frontend/Statements.lean](../Language/Elaboration/Statements.lean) | Calls, assignments, branches, nested loops, generated plans |
| [Frontend/Method.lean](../Language/Elaboration/Method.lean) | Local collection and final method declaration assembly |
