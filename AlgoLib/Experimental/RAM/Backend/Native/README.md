...
| `Prototype/Composition/Native` | Source adapters: linking, expression certificates, and scalar representations |
...
`Backend/Ownership`, `Composition/ResourceRefinement`, `Composition/Focus`,
`Composition/LocalRefinement`, and `Composition/ResidentInputs` now contain
