...
import AlgoLib.Experimental.RAM.Historical.Backend.Certificates.SortingSpec

/-!
# Instruction-level insertion certificates

Proves the machine insertion/sorting routines, their frame properties, and their work bounds.

The insertion adapter reuses the local operation certificate. The complete student method and its
VCs live in Programs/Sorting.
