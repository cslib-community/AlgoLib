...
-/
import AlgoLib.Experimental.RAM.Historical.Backend.Adapters.Search
...
import AlgoLib.Experimental.RAM.Historical.NatMachine.Output

/-!
# Graph/source input/output adapter

Prepares the graph traversal by clearing flags and seeding the valid source, and returns a visited
bitmap view.

Its preparation and representation proofs account for all compiled initialization. Library/Search
exposes the logical adapter equations to method verification.
-/
