...
| [Authoring/Contracts.lean](../../../Language/Model/Contracts.lean) | Complete logical input/output `Specification`, with no backend parameter |
| [Authoring/Mutable.lean](../../../Language/Model/Mutable.lean) | Pure scalar expressions, array operations, guards, and logical charges |
| [LogicalFrontend.lean](../../../Language/Frontend.lean) | Shared source syntax and proof automation; no machine or compiler imports |
