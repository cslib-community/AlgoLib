...
> Historical presentation: this file and the accompanying slide deck describe the pre-layer layout. For current code locations and method declarations, use [ARCHITECTURE.md](ARCHITECTURE.md) and [MIGRATION.md](../../../docs/MIGRATION.md).
