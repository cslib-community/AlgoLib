...
|---|---|
| [Semantics.lean](../../../Language/Model/Semantics.lean) | Mathematical `Program`/`Run`, pure `Action`/`Procedure` contracts, VC soundness, and loop rules; no RAM dependency |
| [Syntax.lean](../../../Language/Model/Syntax.lean) | Compositional body syntax, logical symbolic execution, and time-credit arithmetic |
| [Interface.lean](../../Authoring/Interface.lean) | Library preparation/observation interface and generic certified execution binding |
| [Methods.lean](../../Authoring/Methods.lean) | Input/output declarations, generated method obligations, fixed-body certificates, and the user-facing theorem |
