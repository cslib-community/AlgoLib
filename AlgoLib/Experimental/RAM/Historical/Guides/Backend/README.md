...
|---|---|---|
| [Realization.lean](../../Backend/Realization.lean) | Separate primitive implementations and structural certificate reconstruction | `Compilation M program`: functional refinement and cost transport |
