...
|---|---|
| [Insertion.lean](../../../Backend/Adapters/Insertion.lean) | `todo`/`sorted` state, array representation, insertion action and loop guard |
| [InsertionInput.lean](../../../Backend/Adapters/InsertionInput.lean) | Ordinary list input, prepared initial state, array output observation and preparation cost |
| [Search.lean](../../../Backend/Adapters/Search.lean) | Seen/frontier/row/processed state, BFS operations and guards |
| [SearchInput.lean](../../../Backend/Adapters/SearchInput.lean) | Certified graph/source input, clearing and seeding, returned visited bitmap |
