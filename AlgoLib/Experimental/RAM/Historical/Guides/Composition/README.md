...
For signed arithmetic, see [Nat and Int source types](../../../Language/SIGNED-INTEGERS.md).

See [interface status and migration policy](../../../Verification/API-POLICY.md) before extending the
frontend, and [frontend conformance tests](../../../Tests/Conformance/README.md) for
independent source-to-RAM regression coverage.

The current command interface uses a [generated Lean obligation API](../../../Verification/OBLIGATION-API.md).
...
For algorithm authors, start with [separate named proof blocks](../../../Verification/NAMED-PROOFS.md).
...
See [the explorer walkthrough](../../../Verification/OBLIGATION-API.md#explore-a-goal-in-the-editor).

For a complete graph algorithm, start with [one BFS proof, two FIFO backends](../../../Examples/BFS/TUTORIAL.md).
...
For implementation changes, see [stable encoder/layout contracts and frontend modules](../../../Implementations/IMPLEMENTATION-CONTRACTS.md).
...
[the paper loop tutorial](../../../Language/PAPER-LOOPS.md).
...
For algorithm proofs, `import AlgoLib.Experimental.RAM.Language.Owned` exposes
...
|---|---|---|
| Algorithm | [BufferClient.lean](../../../Examples/Composition/BufferClient.lean) | Mathematical lists, typed calls, a loop invariant, logical budgets |
| Abstract library | [Buffer.lean](../../../Library/Buffer.lean), [Language.lean](../../../Language/Program.lean) | Operation signatures, functional behavior, procedure contracts, public charges |
| Implementation | [BufferImplementation.lean](../../../Implementations/DataStructures/BufferImplementation.lean), [Ownership.lean](../../../Implementations/Natural/Ownership.lean) | Private layouts, owned registers/cells, saved potential, local primitive proofs |
| Compiler/linker | [Linking.lean](../../../Compiler/Assembly/Natural/Linking.lean), [Execution.lean](../../../Compiler/Assembly/Natural/Execution.lean) | Structural certificate reconstruction, existing RAM compilation, inferred execution bounds |

[Loom.lean](../../../Verification/Loom.lean) gives the actual upstream Loom interpretation and proves its
identity, sequencing, and associativity laws. [Demo.lean](../../../Examples/Composition/Demo.lean) selects implementations
and supplies resident input/output views; it contains no repeated algorithm proof.

## Read the mutable program first

Start with [BufferAlgorithms.lean](../../../Examples/Composition/BufferAlgorithms.lean). It uses the existing
...
[Verification.Plan](../../../Verification/Plan.lean) adds annotations indexed by the exact existing
...
[Compatibility.lean](../../Adapters/CreditCompatibility.lean) embeds the existing `Authoring.Program`.
...
Start with [the unified frontend tutorial](../../../Language/FRONTEND.md), [mixed algorithms](../../../Examples/Composition/MixedAlgorithms.lean),
and [insertion sort](../../../Examples/InsertionSort/MinimumCaller.lean). The old array adapter is isolated in
