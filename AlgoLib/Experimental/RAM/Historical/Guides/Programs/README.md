...
- [Sorting.lean](../../Programs/Sorting.lean): `Programs.Sorting.main`, a sorted permutation and quadratic RAM bound.
- [Connectivity.lean](../../Programs/Connectivity.lean): `Programs.Connectivity.main`, exact reachability, connectivity iff the output is the whole vertex set, and a linear RAM bound.

[Examples.lean](../../Programs/Examples.lean) runs them and demonstrates theorem application; it does not contain another implementation.
