...
Start with [BFS.lean](../../Prototype/BFS.lean) for the algorithm and theorem, and
[Graph.lean](../../Prototype/Graph.lean) for its two reusable procedures. These are new prototype
...
```lean
import AlgoLib.Experimental.RAM.Historical.Prototype.BFS
...
returns only the source component. See [GraphTests.lean](../../Prototype/GraphTests.lean) for
