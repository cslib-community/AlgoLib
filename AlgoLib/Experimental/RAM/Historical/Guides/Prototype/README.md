...
The complete [owned BFS tutorial](../../../Examples/BFS/TUTORIAL.md) shows one paper-style
...
For proof authoring, start with [separate named proof blocks](../../../Verification/NAMED-PROOFS.md).
...
[paper loop tutorial](../../../Language/PAPER-LOOPS.md): inferred allowances, named VCs,
and automatically assembled executable theorems.

Start with **[the unified frontend tutorial](../../../Language/FRONTEND.md)** and
[MixedAlgorithms.lean](../../../Examples/Composition/MixedAlgorithms.lean). Arrays, ordinary scalar
locals, and owned procedure calls now share one typed program and one contract VCG.
[Sorting.lean](../../../Examples/InsertionSort/MinimumCaller.lean) contains both insertion-sort loops;
[SortingExecution.lean](../../../Examples/InsertionSort/Execution.lean) runs that exact program
...
[BFS.lean](../../Prototype/BFS.lean), and its [graph procedures](../../Prototype/Graph.lean). The generic
...
The historical array-substitution program is [SortingAlgorithm.lean](../../Prototype/SortingAlgorithm.lean). It exposes
...
```lean
import AlgoLib.Experimental.RAM.Historical.Prototype.InsertionSort
...
[SortingFacts.lean](../../../Library/SortingFacts.lean) proves precisely those mathematical facts,
...
[Tests.lean](../../Prototype/Tests.lean) also verifies a separate array-filling program using the
...
|---|---|---|
| [Frontend](../../Prototype/Frontend.lean) | Parse mutable code; choose private locals; materialize guards; infer frames; attach annotations | Program, contracts, invariants, potential |
| [Mutable](../../Prototype/Mutable.lean) | Reusable assignment, array-read, array-write, comparison and memory-frame certificates | Nothing machine-specific |
| [Observation](../../../Verification/Semantics/Observation.lean), [Interpretation](../../Prototype/Interpretation.lean) | Independent finite execution semantics and connection to the existing source/compiler | Nothing |
| [LoomObservation](../../../Verification/Semantics/LoomObservation.lean) | Instantiate upstream `MAlgOrdered`; identify its `wp` with the cost observation | Nothing |
| [Verification](../../Prototype/Verification.lean) | Generate conditions, prove their soundness, reconstruct a backend certificate | Mathematical lemmas for the generated conditions |
| [InsertionSort](../../Prototype/InsertionSort.lean) | The program, inline annotations, one proof command, executable and main theorem | The textbook sorting argument |
| [Axioms](../../Prototype/Axioms.lean), [FrameworkTests](../../Prototype/FrameworkTests.lean), [Tests](../../Prototype/Tests.lean) | Kernel-dependency guards, framework integration, runtime and rejection regressions | Nothing |
...
- `ram method`: the unified owned frontend described in [FRONTEND.md](../../../Language/FRONTEND.md).
