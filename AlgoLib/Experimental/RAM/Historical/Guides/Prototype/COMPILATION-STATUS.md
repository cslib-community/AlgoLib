...
The checked declaration is in [MultipleArrayTests.lean](../../Prototype/MultipleArrayTests.lean).
...
1. **Ordinary source outcomes.** [VelvetSemantics.lean](../../../Research/Velvet/VelvetSemantics.lean)
...
2. **Loom correctness.** [VelvetWP.lean](../../../Research/Velvet/VelvetWP.lean) proves
...
3. **Target instructions and calls.** [Nondeterministic.lean](../../../Research/Velvet/Nondeterministic.lean)
...
5. **Actual execution.** [NondeterministicRunner.lean](../../../Research/Velvet/NondeterministicRunner.lean)
...
7. **Total execution and the public result.**
   [ExecutableTranslation.lean](../../../Research/Velvet/ExecutableTranslation.lean) adds target
...
The two-array example in [VelvetArrayTranslation.lean](../../../Research/Velvet/VelvetArrayTranslation.lean)
uses [ExecutionBridge.lean](../../Prototype/ExecutionBridge.lean) to expose the machine execution
...
[Axioms.lean](../../Prototype/Axioms.lean) pins kernel dependencies for the new bridges, interpreter,
...
[unified frontend guide](../../../Language/FRONTEND.md).
...
generated automatically. See [the source example](../../../Examples/Composition/BufferAlgorithms.lean)
...
See [the tutorial and exact scope](../../../Language/PAPER-LOOPS.md). This does not extend
...
See [the authoring workflow](../../../Verification/OBLIGATION-API.md).
