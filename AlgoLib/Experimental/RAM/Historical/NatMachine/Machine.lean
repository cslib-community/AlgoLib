...
import AlgoLib.Experimental.RAM.Language.Model.NatArithmetic
import Mathlib.Logic.Function.Basic

/-!
# RAM machine and costed execution

Defines natural-number memory and registers, primitive instruction effects, structured code, and
counted execution.

Every higher-layer cost theorem is eventually related to this semantics. Unit-cost natural-number
operations do not claim bit complexity.
