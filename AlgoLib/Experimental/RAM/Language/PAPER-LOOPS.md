...
For the current proof-authoring workflow, see [named proof blocks](../Verification/NAMED-PROOFS.md).
...
Start with [Sorting.lean](../Examples/InsertionSort/MinimumCaller.lean). The program shows both insertion loops,
...
source locations are separate. See [the complete named-block tutorial](../Verification/NAMED-PROOFS.md)
...
in the execution module, as [SortingExecution.lean](../Examples/InsertionSort/Execution.lean) does.
...
[The owned BFS tutorial](../Examples/BFS/TUTORIAL.md) demonstrates dependent neighbor scans with
